...
urlpatterns = [
    ...
    path('friends/<uuid:id>', friends_information, name="friends_information"),
    path('friends/remove/<uuid:id>',unfriend,name='unfriend'),
    path('friends/add/<uuid:id>',add_friend,name='add_friend'),
